...
public class Client2 {
	    ...
	    public static void main(String[] abc) throws Exception {
	        ...
	        Client2 client2 = new Client2(client);
	        client2.displayMenu();
	 ...
	 // method to display menu
	    ...
	    String selectFile() throws Exception { 
		   ...
		   while(true){
			   ...
			   //<> will help compiler while verifying instead of run time. File storing string values of Array list
		       ArrayList<String> listfiles = new ArrayList<String>(); 
		       ArrayList<String> listdirectories = new ArrayList<String>();
				
		       //folder has path of the directory, for file operations it should be of File type. list of files is storing files and directory.
		       File[] listOfFiles = folder.listFiles();
			    ...
			    for(int i=0;i<listdirectories.size();i++){
			    	System.out.println("" + (i+1) + ":"+ listdirectories.get(i));//for array list we have to use get() to get an element at specified index.
